...
?>
<div class="tab-pane <?php if (isset($this->active[1]) && $this->active[1] == "config") : ?>active<?php endif; ?>" id="formConfig">
				...
				<tr>
					<td class="nowrap has-context">
						...
						<div class="pull-right">
							...
							<a href="<?php echo JRoute::_("index.php?option=com_jdeveloper&task=form.add&tag=fields&relation=component." . $this->item->id . ".config&parent_id=" . $field->id); ?>"class="btn btn-small btn-success" style="width:65px; margin:1px;">
								<i class="icon-new"></i> Fields
							</a>
							<a href="<?php echo JRoute::_("index.php?option=com_jdeveloper&task=form.add&tag=fieldset&relation=component." . $this->item->id . ".config&parent_id=" . $field->id); ?>"class="btn btn-small btn-success" style="width:65px; margin:1px;">
								<i class="icon-new"></i> Fieldset
							</a>
							<?php endif; ?>
							<?php if ($field->tag == "fieldset") : ?>
							<a href="<?php echo JRoute::_("index.php?option=com_jdeveloper&task=form.add&tag=field&relation=component." . $this->item->id . ".config&parent_id=" . $field->id); ?>"class="btn btn-small btn-success" style="width:65px; margin:1px;">
	...
	<a href="<?php echo JRoute::_("index.php?option=com_jdeveloper&task=form.add&tag=fields&relation=component." . $this->item->id . ".config&parent_id=" . $this->item->form_id); ?>"class="btn btn-small btn-success" style="width:65px; margin:1px;">
		<i class="icon-new"></i> Fields
	</a>
	<a href="<?php echo JRoute::_("index.php?option=com_jdeveloper&task=form.add&tag=field&relation=component." . $this->item->id . ".config&parent_id=" . $this->item->form_id); ?>"class="btn btn-small btn-success" style="width:65px; margin:1px;">
		<i class="icon-new"></i> Field
	</a>
</div>
