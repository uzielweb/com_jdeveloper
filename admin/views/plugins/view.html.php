...
/**
 * JDeveloper Plugins View
 *
 * @package     JDeveloper
 * @subpackage  Views
 */
class JDeveloperViewPlugins extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JDeveloperHelper::addSubmenu('plugins');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JDEVELOPER_PLUGINS'));
