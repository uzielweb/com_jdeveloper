...
?>
<h2><?php echo JText::_("COM_JDEVELOPER_MODULE_FORMS"); ?></h2>
...
<div class="tab-content">
	<div class="tab-pane active" id="formConfig">
		<table class="table" id="fieldListConfig">
			<thead>
				<tr>
					...
					<th class="nowrap left"><?php echo JText::_('COM_JDEVELOPER_MODULE_FIELD_EDIT_LABEL'); ?></th>
				</tr>
			</thead>
			<tbody>
					...
					<tr>
						<td class="nowrap has-context">
							...
							<div class="pull-right">
								...
								<a href="<?php echo JRoute::_("index.php?option=com_jdeveloper&task=form.add&tag=fields&relation=module." . $this->item->id . ".config&parent_id=" . $field->id); ?>"class="btn btn-small btn-success" style="width:65px; margin:1px;">
									<i class="icon-new"></i> Fields
								</a>
								<a href="<?php echo JRoute::_("index.php?option=com_jdeveloper&task=form.add&tag=fieldset&relation=module." . $this->item->id . ".config&parent_id=" . $field->id); ?>"class="btn btn-small btn-success" style="width:65px; margin:1px;">
									<i class="icon-new"></i> Fieldset
								</a>
								<?php endif; ?>
								<?php if ($field->tag == "fieldset") : ?>
								<a href="<?php echo JRoute::_("index.php?option=com_jdeveloper&task=form.add&tag=field&relation=module." . $this->item->id . ".config&parent_id=" . $field->id); ?>"class="btn btn-small btn-success" style="width:65px; margin:1px;">
		...
		<a href="<?php echo JRoute::_("index.php?option=com_jdeveloper&task=form.add&tag=fields&relation=module." . $this->item->id . ".config&parent_id=" . $this->item->form_id); ?>"class="btn btn-small btn-success" style="width:65px; margin:1px;">
			<i class="icon-new"></i> Fields
		</a>
		<a href="<?php echo JRoute::_("index.php?option=com_jdeveloper&task=form.add&tag=field&relation=module." . $this->item->id . ".config&parent_id=" . $this->item->form_id); ?>"class="btn btn-small btn-success" style="width:65px; margin:1px;">
			<i class="icon-new"></i> Field
		</a>
	</div>
</div>