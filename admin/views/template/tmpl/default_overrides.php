...
$override_add = JRoute::_("index.php?option=com_jdeveloper&task=override.add&type=template&item_id=" . $this->item->id);
?>
<div class="row-fluid">
	<div class="span12">
		<h2><?php echo JText::_("COM_JDEVELOPER_TEMPLATE_OVERRIDES") ?></h2>
		...
		<a href="<?php echo JRoute::_("index.php?option=com_jdeveloper&view=overrides&filter[type]=template&filter[item_id]=" . $this->item->id); ?>" class="btn btn-primary"><?php echo JText::_("COM_JDEVELOPER_OVERRIDES_MANAGE") ?></a>
		<p>&nbsp;</p>
		<table class="table table-striped">
			<thead>
				<tr>
					<th><?php echo JText::_("COM_JDEVELOPER_TEMPLATE_FIELD_OVERRIDE_NAME_LABEL") ?></th>
		...
		<div class="modal hide fade" id="addOverride" style="width:600px;">
			<div class="modal-header">
				<h3><?php echo JText::sprintf('COM_JDEVELOPER_MODULE_ADD_OVERRIDE');?></h3>
			</div>
			<div class="modal-body">
				<?php echo JText::sprintf('COM_JDEVELOPER_MODULE_ADD_OVERRIDE_DESC');?>
				<table class="table table-striped">
					<thead>
						<tr>
							<th><?php echo JText::_("COM_JDEVELOPER_MODULE_FIELD_OVERRIDE_NAME_LABEL"); ?></th>
						</tr>					
					</thead>
					<tbody>
						<tr>
