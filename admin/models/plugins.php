...
/**
 * JDeveloper Plugins Model
 *
 * @package     JDeveloper
 * @subpackage  Models
 */
class JDeveloperModelPlugins extends JModelList
{
	/**
	 * Constructor
	 *
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*')->from('#__jdeveloper_plugins AS a');
	...
	public function getAuthors()
	{
		...
		$query->select('u.id AS value, u.name AS text')
			->from('#__users AS u')
			->join('INNER', '#__jdeveloper_plugins AS a ON a.created_by = u.id')
			->group('u.id, u.name')
			->order('u.name');
