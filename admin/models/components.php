...
/**
 * JDeveloper Components Model
 *
 * @package     JDeveloper
 * @subpackage  Models
 */
class JDeveloperModelComponents extends JModelList
{
	/**
	 * Constructor
	 *
	...
	protected function getListQuery()
	{
		$db = $this->getDbo();
		$query = $db->getQuery(true);
		$query->select('a.*')->from('#__jdeveloper_components AS a');
	...
	public function getAuthors()
	{
		...
		$query->select('u.id AS value, u.name AS text')
			->from('#__users AS u')
			->join('INNER', '#__jdeveloper_components AS a ON a.created_by = u.id')
			->group('u.id, u.name')
			->order('u.name');
